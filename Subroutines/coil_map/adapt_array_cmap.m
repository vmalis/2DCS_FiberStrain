function [recon,cmap]=adapt_array_cmap(yn,rn,norm);
...
%-------------------------------------------------------------------------
% Vadim Malis
% UCSD Muscle Imaging and Modeling group
% August 2018
%-------------------------------------------------------------------------
% input:
%   
%   1)  yn: array data to be combined [ny, nx, nc]. 
%	2)  rn: data covariance matrix [nc, nc].
%	3)  norm: =1, normalize image intensity
%
% output:
%	1)  recon: reconstructed image [ny, nx].
%	2)  cmap: estimated coil sensitivity maps [ny, nx, nc].
%
%
%
